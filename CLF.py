...
st.write(spiro_df)
st.caption(""" FEV1 = forced expiratory volume in 1s ; 
""")
st.caption("""  FVC = forced vital capacity; 
""")
st.caption(""" FEV1/FVC = FEV1/FVC ratio;
""")
st.caption("""FEF25-75% = forced mid-expiratory flow; 
""")
st.caption("""LLN = lower limit of normal
""")
